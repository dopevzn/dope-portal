    ...
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#d8ff42]">Private capital access</p>
          ...
          <div className="max-w-xl lg:pb-2">
            <p className="text-lg leading-8 text-white/65">
              The DOPE VZN Capital Room provides prospective investment partners with a clear view of the company, financial model, growth plan, and capital strategy.
            </p>
            <Link
              href="/investors/david-keyser"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#d8ff42] px-6 py-3 text-sm font-bold text-black transition hover:scale-[1.02]"
            >
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-white/40">Core materials</p>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <Icon className="size-5 text-[#d8ff42]" />
